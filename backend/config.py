...
class Settings:
    ...
    APPROVED_LEAVE_THRESHOLD_PERCENT = float(os.getenv("APPROVED_LEAVE_THRESHOLD_PERCENT", "10.0"))
    APPROVED_LEAVE_EXCESS_PENALTY = float(os.getenv("APPROVED_LEAVE_EXCESS_PENALTY", "1.0"))
    REJECTED_LEAVE_REQUEST_PENALTY = float(os.getenv("REJECTED_LEAVE_REQUEST_PENALTY", "1.0"))
